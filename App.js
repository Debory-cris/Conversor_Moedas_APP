...
import { KeyboardAvoidingView, Platform, ScrollView, ActivityIndicator, Text, TouchableOpacity, View } from 'react-native';
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Selecione as moedas e insira o valor para converter.</Text>
          </View>
